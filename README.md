...
L'application MedRdv sert à la gestion des rendez-vous d'un medecin lui permetant d'avoir un meilleur suivi de ses differents patients et aussi elle permet aux patients de pouvoir s'enregister afin de reserver des rendez-vous avec un mmedecin.   
